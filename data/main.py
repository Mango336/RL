import gym
from gridworld import CliffWakingWapper  # gridworld.py文件
...
def main():
    env = gym.make("CliffWaking-v0")  # 0 up, 1 right, 2 down, 3 left
    env = CliffWakingWapper(env)
    ...
    for episode in range(50):
        ...
        if episode%20 == 0:  # 每隔20个episode 渲染 看效果
            is_render = True
        else:
            is_render = False
    # 训练结束 查看算法效果
